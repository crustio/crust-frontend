<template>
  <div class="container flex px-3 md:pt-16">
        ...
        <div class="content__form__area">
          ...
          <div class="contact__form__inner">
            ...
            <button @click="handleSubmit"
              class="bg-[#FA8C16] min-w-[192px] text-white p-3 mt-[32px]  rounded-[6px] hover:bg-[#F97316] transition duration-300">
              Submit
            </button>
          </div>
...
const handleSubmit = () => {
  ...
  // You can perform additional actions or make API calls here
};
</script>
